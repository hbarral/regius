...
func newTestRedisStore(t *testing.T) (*RedisStore, *miniredis.Miniredis) {
	...
	return NewRedisStore(pool, "test:jobs"), mr
}

func TestRedisStore_ClaimOrderAndReadiness(t *testing.T) {
...
func TestRedisStore_ClaimAtomicity(t *testing.T) {
	s, _ := newTestRedisStore(t)
	ctx := context.Background()
	const total = 50
	for i := 0; i < total; i++ {
...
func TestRedisStore_PayloadRoundTrip(t *testing.T) {
	s, _ := newTestRedisStore(t)
	ctx := context.Background()
...
func TestRedisStore_CompleteAndFail(t *testing.T) {
	s, _ := newTestRedisStore(t)
	ctx := context.Background()
...
func TestRedisStore_ReclaimExpired(t *testing.T) {
	s, _ := newTestRedisStore(t)
	ctx := context.Background()
...
func TestRedisStore_RetryDrop(t *testing.T) {
	s, _ := newTestRedisStore(t)
	ctx := context.Background()
...
func TestRedisStore_StatsListGet(t *testing.T) {
	s, _ := newTestRedisStore(t)
	ctx := context.Background()
...
func TestRedisStore_ListOrdersNewestFirst(t *testing.T) {
	s, _ := newTestRedisStore(t)
	ctx := context.Background()
...
func TestRedisStore_TryLock(t *testing.T) {
...
func TestManager_OverRedisStore(t *testing.T) {
	mr := miniredis.RunT(t)
	pool := &redis.Pool{
		MaxActive: 50,
		Dial: func() (redis.Conn, error) {
	...
	t.Cleanup(func() { pool.Close() })
	m := New(NewRedisStore(pool, "test:jobs"), ManagerOptions{Workers: 1, PollInterval: time.Millisecond})
